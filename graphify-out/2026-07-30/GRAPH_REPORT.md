...
## Corpus Check
- 137 files · ~104,311 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 827 nodes · 2205 edges · 76 communities (37 shown, 39 thin omitted)
...
### Community 0 - "useAuth"
Cohesion: 0.07
Nodes (59): ForgotPasswordScreen(), LoginScreen(), mapAuthError(), FieldErrors, RegisterScreen(), PublishDeckScreen(), AddCardsScreen(), Mode (+51 more)

### Community 1 - "useThemeColors"
Cohesion: 0.07
Nodes (51): Slide, SlideFace(), SLIDES, QuizScreen(), StudySessionScreen(), shuffle(), WriteScreen(), CardImages() (+43 more)

### Community 2 - "progress.tsx"
Cohesion: 0.06
Nodes (62): AchievementsScreen(), stripEmoji(), LevelsScreen(), ProfileScreen(), ProgressScreen(), StatCard(), ActivityHeatmap(), ActivityHeatmapProps (+54 more)

### Community 3 - "FloatingTabBar.tsx"
Cohesion: 0.16
Nodes (15): TabsLayout(), AnimatedBlurView, AnimatedPressable, barShadow, FloatingTabBar(), SLIDE_SPRING, IoniconName, TabBarIcon() (+7 more)

### Community 4 - "decks.tsx"
Cohesion: 0.08
Nodes (45): accuracyColor(), DeckDetailScreen(), Tab, DECK_SORTS, DeckSort, DecksScreen(), ConflictResolution, ImportConflictModal() (+37 more)

### Community 5 - "database.ts"
Cohesion: 0.08
Nodes (46): AuthorReply(), CommunityDeckScreen(), Metric(), MiniAvatar(), PublishToggle(), PublishToggleProps, AuthContextType, NewDeckInput (+38 more)

### Community 6 - "settings.tsx"
Cohesion: 0.28
Nodes (10): SettingsScreen(), SettingsRow(), dateToHm(), hmToDate(), TimePickerRow(), TimePickerRowProps, clampGoal(), clampTimerLimit() (+2 more)
...
Cohesion: 0.38
Nodes (7): HomeScreen(), StreakBadge(), StreakBadgeProps, useStudyModePicker(), getDueCards(), getNewCards(), getSessionCards()

### Community 20 - "community.tsx"
Cohesion: 0.21
Nodes (12): COMMUNITY_SORTS, CommunityScreen(), LIST_TITLE, RevealSearchBar(), RevealSearchBarProps, SearchToggleButton(), SearchToggleButtonProps, useRevealSearch() (+4 more)
...
### Community 36 - "useStudySession.ts"
Cohesion: 0.22
Nodes (16): useActiveTimer(), CardAnswer, useStudySession(), checkAchievements(), reviewCard(), prefetchCardImages(), androidChannel(), dateAt() (+8 more)

### Community 37 - "useSettings"
Cohesion: 0.13
Nodes (18): FONT_BASE, FONT_SCALE, LEADING_BASE, NotificationController(), RootNavigator(), THEME_MAP, ThemeController(), ThemeVarsView() (+10 more)
...
Cohesion: 0.30
Nodes (9): EnterAnimation(), EnterAnimationProps, barGlass(), compensateWeakBlur(), GLASS_DARK, GLASS_LIGHT, glassShadow, GlassTokens (+1 more)

### Community 51 - "types/index.ts"
Cohesion: 0.24
Nodes (10): StudySetupProps, useStudyTimer(), UseStudyTimerArgs, TimedSessionTarget, useTimedSession(), DeckOrigin, Grade, StudyPhase (+2 more)

### Community 55 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 61 - "useGlass"
Cohesion: 0.21
...
### Community 63 - "Flashcard"
Cohesion: 0.35
Nodes (8): AiGeneratorFormProps, FlashCard(), FlashCardProps, QuizQuestionProps, SwipeCard(), SwipeCardProps, useCardSize(), Flashcard
...
## Knowledge Gaps
- **233 isolated node(s):** `name`, `slug`, `version`, `orientation`, `userInterfaceStyle` (+228 more)
...
- **Why does `useThemeColors()` connect `useThemeColors` to `useAuth`, `progress.tsx`, `FloatingTabBar.tsx`, `decks.tsx`, `useSettings`, `database.ts`, `settings.tsx`, `Deck`, `index.tsx`, `community.tsx`, `useGlass`, `Flashcard`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `expo-router` connect `useAuth` to `useThemeColors`, `progress.tsx`, `FloatingTabBar.tsx`, `decks.tsx`, `useSettings`, `database.ts`, `expo`, `settings.tsx`, `index.tsx`, `community.tsx`, `useGlass`?**
