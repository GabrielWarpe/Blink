...
export const LIGHT_COLORS: ThemePalette = {
  background: '#e2e2df',
  surface: '#e2e2df',
  surfaceContainerLow: '#e7e7e4',
  surfaceContainer: '#ecece9',
  surfaceContainerHigh: '#d9d9d6',
  surfaceContainerHighest: '#cececb',
  surfaceBright: '#f1f1ee',
  primary: '#111111',
  primaryContainer: '#111111',
  onPrimary: '#f7f7f5',
  onPrimaryContainer: '#f1f1ee',
  secondary: '#52525b',
  secondaryContainer: '#ddddda',
  tertiary: '#a16207', // dourado escurecido para contrastar no claro
  tertiaryContainer: '#eedfba',
  onSurface: '#111111',
  onSurfaceVariant: '#52525b',
  outlineVariant: '#cdcdca',
  outline: '#78787d',
  error: '#d92d20',
  success: '#15803d',
  warning: '#a16207',
